...
export const INITIATIVES: Initiative[] = [
  {
    ...
    metrics: [
      { name: 'No. of pre-BS VI trucks converted',                      type: 'outcome',  target: 76496, achieved: 38248, unit: 'vehicles', format: 'X/Y', trackingFrequency: 'monthly', lowestLevelLabel: 'RTO',      dataSource: 'API (MoRTH portal)', cluster: 'pre-bs-vi', clusterLabel: 'Pre-BS VI converted', clusterType: 'outcome', clusterSubLabel: 'Trucks' },
      { name: 'No. of pre-BS VI buses converted',                       type: 'outcome',  target: 10000, achieved: 6500,  unit: 'vehicles', format: 'X/Y', trackingFrequency: 'monthly', lowestLevelLabel: 'RTO',      dataSource: 'API (MoRTH portal)', cluster: 'pre-bs-vi', clusterSubLabel: 'Buses' },
      { name: 'No. of events conducted',                                type: 'outcome',  target: 300,   achieved: 81,                       format: 'X/Y', trackingFrequency: 'monthly', lowestLevelLabel: 'City', dataSource: 'API (States)',     cluster: 'events',    clusterLabel: 'Events',             clusterType: 'progress', clusterSubLabel: 'Conducted', clusterRender: 'ratio' },
      { name: 'No. of events planned',                                  type: 'progress', target: 250,   achieved: 175,                      format: 'X/Y', trackingFrequency: 'monthly', lowestLevelLabel: 'City', dataSource: 'API (TBD)',        cluster: 'events',    clusterSubLabel: 'Planned' },
  ...
  },
  {
    ...
    metrics: [
      ...
      { name: 'No. of industries in violation of norms',                    type: 'progress', target: 500, achieved: 80,  isInverse: true, denominatorLabel: 'Total Sites',       format: 'X/Y', trackingFrequency: 'monthly', lowestLevelLabel: 'State', dataSource: 'API (CEMS CPCB)' },
  ...
  },
  {
    ...
    metrics: [
      ...
      { name: 'Adequate recycling plant capacity in place',            type: 'readiness', target: 1,    achieved: 0,                                   format: 'Y/N', trackingFrequency: 'overall', lowestLevelLabel: 'City', dataSource: 'Manual', visibleWhen: 'state' },
