...
export const INITIATIVES: Initiative[] = [
  {
    ...
    metrics: [
      ...
      { name: 'No. of events conducted',                                type: 'outcome',  target: 300,   achieved: 81,                       format: 'X/Y', trackingFrequency: 'monthly', lowestLevelLabel: 'City', dataSource: 'API (States)',     cluster: 'events',    clusterLabel: 'Events',             clusterType: 'progress', clusterSubLabel: 'Conducted' },
